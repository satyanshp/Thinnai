      ...
      <Box display="flex" flexDirection="column">
        ...
        >
          ...
          >
            ...
            />
            <div
              onClick={() => navigate(ROUTES.POLICY_BASE + "/privacy-policy")}
            >
              <Box
                style={{
                  cursor: "pointer",
              ...
              <>
                ...
                <div
                  onClick={() =>
                    navigate(
                      ROUTES.POLICY_BASE +
                        "/updation-cancellation-and-reschedule"
                    )
                  }
                >
                  <Box
          ...
          <Box
            display="flex"
            gap={{ md: 3, xs: "0.813rem", sm: "0.813rem" }}
            alignItems="center"
          >
            ...
            <Box display="flex" gap={{ md: 2, xs: 1 }} alignItems="center">
              ...
              >
                <a
                  href="https://www.instagram.com/bookmythinnai"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img
              ...
              >
                <a
                  href="https://www.facebook.com/thinnai.social"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img
