...
const NavBar = ({
	...
	const bookingDate = useSelector<RootState, string>(state => state.search.bookingDate);
												...
												<Box width='100%' display='flex' justifyContent='space-evenly'>
													<Box display='flex' alignItems='center' gap={0.5}>
														<Box display='flex' alignItems='center'>
															<LocationOnIcon sx={{ fontSize: { xs: '3vw', sm: '1vw' } }} />
														</Box>
														<Box
															fontSize={{
																sm: '0.9vw',
													...
													<Box width='0.05vw' height='auto' sx={{ background: '#A4A4A4' }} />
													<Box display='flex' alignItems='center' gap={0.5}>
														<Box display='flex' alignItems='center'>
															<GroupsIcon sx={{ fontSize: { xs: '3.2vw', sm: '1.2vw' } }} />
														</Box>
														<Box
															fontSize={{
																sm: '0.9vw',
													...
													<Box display='flex' alignItems='center' gap={0.5}>
														<Box display='flex' alignItems='center'>
															<CalendarMonthIcon sx={{ fontSize: { xs: '3vw', sm: '1vw' } }} />
														</Box>
														<Box
															fontSize={{
																sm: '0.9vw',
								...
								{stateSearched && (
									...
									>
										...
										>
											...
											>
												<Box height='100%'>
													<Button style={{ height: '100%' }} onClick={() => onClickBack()}>
